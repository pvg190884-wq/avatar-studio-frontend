...
const CASES_INFO = [
  {
    ...
    points: [
      'Фото: JPG/PNG, лицо анфас крупным планом, хорошее равномерное освещение — любой размер файла, сжимается автоматически перед отправкой',
      'Образец голоса: WAV/MP3, 10–20 секунд чистой речи без музыки и фонового шума — любой размер файла, сжимается автоматически',
  ...
  },
  {
    ...
    points: [
      'Фото: JPG/PNG, лицо анфас крупным планом — любой размер файла, сжимается автоматически',
      `Аудио: WAV/MP3, длительность до ${MAX_CLIP_SECONDS} секунд — любой размер файла, сжимается автоматически`,
  ...
  },
  {
    ...
    points: [
      'Видео: MP4, лицо должно быть видно на протяжении всей записи, размер файла — до ~20 МБ (автосжатие видео пока не реализовано)',
      `Аудио-драйвер: WAV/MP3, до ${MAX_CLIP_SECONDS} секунд — любой размер файла, сжимается автоматически`,
      'Синхронизируются только губы — мимика и движения берутся из исходного видео',
    ],
  },
]
