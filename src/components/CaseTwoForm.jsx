...
import { submitPhotoEmotion, estimateCost, readAudioDuration } from '../api'
...
export default function CaseTwoForm({ onBack, balance }) {
  ...
  const canSubmit = image && audio && !submitting
    ...
    <div className="panel">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <FileDrop
          ...
          onChange={setAudio}
          label="Аудио"
          hint="готовая запись — модель сама подстроит эмоции"
        />
